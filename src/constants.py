...
BIOME_COLORS = {
    ...
    5: (11, 102, 89),    # Taiga
    6: (7, 249, 178),    # Swamp
    247: (0, 207, 117),  # Mangrove Swamp
    7: (86, 173, 245),   # River
    16: (250, 222, 85),  # Beach
    24: (0, 0, 80),      # Deep Ocean
    25: (162, 162, 132), # Stone Shore
    35: (189, 178, 95),  # Savanna
    37: (219, 127, 57),  # Badlands
    45: (0, 119, 190),   # Lukewarm Ocean
    129: (180, 200, 50), # Sunflower Plains
}
